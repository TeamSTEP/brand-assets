...
The design system lives in [TeamSTEP/brand-assets](https://github.com/TeamSTEP/brand-assets) under `packages/design-system` and publishes to **GitHub Packages** under the `@teamstep` scope.
